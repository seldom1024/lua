...
--- 设置默认输入文件文件为 HelloWorld.lua
io.input(file)
--- 输出文件第一行
print(io.read())

--- 输出文件第5个字符，注意句子后面又一个换行符
print(io.read(5))
...
---
print("=========")
for line in io.lines("HelloWorld.lua") do
    print(line)
end


--- 以下实例使用了 seek 方法，定位到文件倒数第 5 个位置并使用 read 方法的 *a 参数，
--- 即从当期位置(倒数第 5 个位置)读取整个文件。
